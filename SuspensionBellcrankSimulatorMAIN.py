...
if __name__ == '__main__':
    ...
    with open("SuspensionDynamicGeometryFRONT.txt", 'w') as g1, open("SuspensionDynamicGeometryREAR.txt", 'w') as g2, \
        open("SuspensionDynamicGeometryFRONTalt.txt", 'w') as g3, open("SuspensionDynamicGeometryREARalt.txt", 'w') as g4:
        g1.truncate(0)
    ...
    g3.close()
    g4.close()
    with open("SuspensionDynamicForcesFRONT.txt", 'w') as f1, open("SuspensionDynamicForcesREAR.txt", 'w') as f2, \
        open("SuspensionDynamicForcesFRONTalt.txt", 'w') as f3, open("SuspensionDynamicForcesREARalt.txt", 'w') as f4:
        f1.truncate(0)
